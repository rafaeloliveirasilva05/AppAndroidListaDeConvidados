...
public class AdapterRecycler2View extends RecyclerView.Adapter {
    ...
    public AdapterRecycler2View(List<Cliente> clientes, Context context, int c){
                ...
                if(inLongClick){
                    ...
                    if(c == 1){
                        ...
                        Toast.makeText(context,"Long Click: "
                                +cliente.nomeSobrenome,Toast.LENGTH_SHORT).show();
        ...
        builder.setView(view)
                .setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        clientes.get(position).compareceuFesta = "1";
